...
plt.title('Comparaison IID vs Non-IID avec Blockchain Fabric (5 rounds)')
plt.legend()
plt.grid(True, alpha=0.3)
plt.ylim(0, 1.05)
plt.savefig('comparaison_iid_non_iid_5rounds.png', dpi=150)
print("\n✅ Graphique sauvegardé sous 'comparaison_iid_non_iid_5rounds.png'")
